...
public class PracenaVoznja {
  ...
  /**
   * Inicijalizacija objekta PracenaVoznja.
   */
  public PracenaVoznja() {}
   ...
   */
  public PracenaVoznja(int id, int broj, long vrijeme, double brzina, double snaga, double struja,
